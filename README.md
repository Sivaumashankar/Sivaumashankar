...
<p align="center">
<img src="https://skillicons.dev/icons?i=aws,linux,bash,jenkins,docker,kubernetes,ansible,terraform,git,github,mysql,nginx" />
</p>

<p align="center">
<img src="https://argo-cd.readthedocs.io/en/stable/assets/logo.png" width="50"/>
<img src="https://helm.sh/img/helm.svg" width="50"/>
<img src="https://prometheus.io/assets/prometheus_logo_grey.svg" width="50"/>
<img src="https://grafana.com/static/img/menu/grafana2.svg" width="50"/>
</p>
...
✔️ Provisioned complete AWS infrastructure using reusable Terraform modules  
✔️ Implemented Jenkins CI/CD with Git Webhooks  
✔️ Containerized apps using Docker & deployed on Amazon EKS  
✔️ Implemented GitOps using Argo CD  
✔️ Configured ALB + Auto Scaling for high availability  
✔️ Integrated AWS Secrets Manager for secure credential management  
✔️ Monitoring with CloudWatch, Prometheus & Grafana  
...
![Snake animation](https://github.com/Sivaumashankar/Sivaumashankar/blob/output/github-contribution-grid-snake.svg)
